#include "src/mainrelay.h"
#include "src/dbdrivers/dbdriver.h"

//Because of the lack of prom.h and promhttp.h header files, this macro is defined！
#define TURN_NO_PROMETHEUS

#if !defined(TURN_NO_PROMETHEUS)
#include "src/prom_server.h"
#endif
